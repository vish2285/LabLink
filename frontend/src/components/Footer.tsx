      ...
      <div className="mx-auto max-w-screen-xl px-4 md:px-8">
        <div className="flex flex-col items-center justify-between gap-2 sm:flex-row">
          ...
          <nav className="flex flex-wrap items-center gap-x-6 gap-y-1 text-sm text-slate-400">
            ...
            <a className="hover:underline hover:text-white" href="#privacy">Privacy</a>
            <a className="hover:underline hover:text-white" href="#terms">Terms</a>
            <a className="hover:underline hover:text-white" href="mailto:lablink@ucdavis.edu">Email</a>
            <a className="hover:underline hover:text-white" href="#report-bug">Report a Bug</a>
          </nav>
