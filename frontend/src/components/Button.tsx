...
function ButtonBase({
  ...
  const base = 'inline-flex items-center justify-center whitespace-nowrap rounded-md transition focus:outline-none focus:ring-2 focus:ring-slate-300 dark:focus:ring-white/20'
  const sizes: Record<Size, string> = {
    sm: 'h-9 px-3 text-sm',
    md: 'h-10 px-4 text-sm',
  }
  const variants: Record<Variant, string> = {
    primary: 'bg-[#1b2e70] text-white shadow-lg ring-1 ring-slate-300/60 dark:ring-white/10 hover:bg-[#1e3a8a] active:scale-[0.99] disabled:opacity-60',
